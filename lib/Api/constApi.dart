...
const GETPROGRESSUSER = '/api/user/progress/';
...
const UPDATEMDPADMIN = '/api/admin/password';
const UPDATEMDPUSER = '/api/user/password';
...
const ADDCOMMENTUSERTOLESSON = '/api/lesson/user/comment/';
const ADDCOMMENTADMINTOLESSON = '/api/lesson/admin/comment/';
